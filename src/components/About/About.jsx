                    ...
                    <div className="space-y-8">
                      ...
                      <div className="flex gap-5">
                        ...
                        <div className="bg-base-100 rounded-3xl p-6 shadow-md border border-base-300 w-full">
                          ...
                          <p className="text-sm text-base-content/60 mb-4">
                            November 2024 – October 2025 | Oslo, Norway
                          </p>
                          <p className="text-base-content/75 leading-8">
                    ...
                    <div className="space-y-8">
                      <div className="flex gap-5">
                        ...
                        <div className="bg-base-100 rounded-3xl p-6 shadow-md border border-base-300 w-full">
                          ...
                          <p className="text-base-content/75 leading-8">
                            Specialized in interaction design and information
                            systems, with a strong focus on user-centered
                            design. Through my master’s, I developed a solid
                            understanding of user experience, particularly in
                            CSCW and Participatory Design (PD), shaping how I
                            design intuitive, collaborative, and meaningful
                            digital solutions. <br />
                            Thesis: “Development & Assessment of a Gamified
                        ...
                        <div className="space-y-6">
                          <div>
                            ...
                            <p className="text-sm text-base-content/60 mb-2">
                              Co-author — (Information, MDPI)
                            </p>
                            <p className="text-base-content/75">
                              Focused on gamification techniques and user
                              engagement in digital learning platforms
                            </p>
                          </div>
                          <div>
                            <h4 className="font-semibold text-lg">
                              A Collaborative Digital Platform for Charity
                              Thrift Store Workers (2024)
                            </h4>
                            <p className="text-sm text-base-content/60 mb-2">
                              Co-author — (IARIA Conference)
                            </p>
                            <p className="text-base-content/75">
                              Research on collaborative systems and user
